object Config {
  object AppConfig {
    const val appId = "app.bosta.task"
  ...
  object Environments {
    const val roomDb = "\"bosta_db\""
    const val debugBaseUrl = "\"https://jsonplaceholder.typicode.com/\""
    const val releaseBaseUrl = "\"https://jsonplaceholder.typicode.com/\""
  }
}